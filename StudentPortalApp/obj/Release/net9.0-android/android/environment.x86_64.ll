...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001abd, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001abc, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [873 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x0443aed2d3d44085, ; from name: StudentPortalApp.dll.so
		i64 u0x2c7b8388dc40a0ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-StudentPortalApp.dll.so
		ptr null; void* handle
	}, ; 13
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.59_name, ; name: libaot-Xamarin.GooglePlayServices.Tasks.dll.so
		ptr null; void* handle
	}, ; 17
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.56_name, ; name: libaot-Xamarin.GooglePlayServices.Base.dll.so
		ptr null; void* handle
	}, ; 60
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.52_name, ; name: libaot-Xamarin.AndroidX.VersionedParcelable.dll.so
		ptr null; void* handle
	}, ; 62
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x143213404f975b94, ; from name: StudentPortalApp
		i64 u0x2c7b8388dc40a0ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-StudentPortalApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x22ffa4093d8c7c8d, ; from name: StudentPortalApp.so
		i64 u0x2c7b8388dc40a0ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-StudentPortalApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x2c7b8388dc40a0ab, ; from name: libaot-StudentPortalApp.dll.so
		i64 u0x2c7b8388dc40a0ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-StudentPortalApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.58_name, ; name: libaot-Xamarin.GooglePlayServices.Location.dll.so
		ptr null; void* handle
	}, ; 156
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x7c7f63c91d7f59e7, ; from name: aot-StudentPortalApp.dll.so
		i64 u0x2c7b8388dc40a0ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-StudentPortalApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8b7ecb018cecb565, ; from name: aot-StudentPortalApp.so
		i64 u0x2c7b8388dc40a0ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-StudentPortalApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x9f4c8fedacc52573, ; from name: libaot-StudentPortalApp
		i64 u0x2c7b8388dc40a0ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-StudentPortalApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc9e818953be3ba2e, ; from name: aot-StudentPortalApp
		i64 u0x2c7b8388dc40a0ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-StudentPortalApp.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xfd343ef9a36be286, ; from name: libaot-StudentPortalApp.so
		i64 u0x2c7b8388dc40a0ab, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-StudentPortalApp.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [33 x i8] c"com.companyname.studentportalapp\00", align 16
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [31 x i8] c"libaot-StudentPortalApp.dll.so\00", align 16
...
@.DSOCacheEntry.52_name = private unnamed_addr constant [51 x i8] c"libaot-Xamarin.AndroidX.VersionedParcelable.dll.so\00", align 16
...
@.DSOCacheEntry.56_name = private unnamed_addr constant [46 x i8] c"libaot-Xamarin.GooglePlayServices.Base.dll.so\00", align 16
...
@.DSOCacheEntry.58_name = private unnamed_addr constant [50 x i8] c"libaot-Xamarin.GooglePlayServices.Location.dll.so\00", align 16
@.DSOCacheEntry.59_name = private unnamed_addr constant [47 x i8] c"libaot-Xamarin.GooglePlayServices.Tasks.dll.so\00", align 16
